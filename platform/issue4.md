...
Use `GET /plan-subscriptions/page`, `POST /plan-subscriptions`, or `DELETE /plan-subscriptions/{id}`

### 1.3 Key code evidence

1. `PlanSubscriptionController.java`

Evidence location: https://gitee.com/fuyang_lipengjun/platform/blob/master/PlanSubscriptionController.java#L49
2. `ProductSubscriptionServiceImpl.java`

Evidence location: https://gitee.com/fuyang_lipengjun/platform/blob/master/ProductSubscriptionServiceImpl.java#L37
3. `PlanDefResMapper.xml`

Evidence location: https://gitee.com/fuyang_lipengjun/platform/blob/master/PlanDefResMapper.xml#L10
...
Add subscription management permissions and verify tenant/plan manageability before list/create/delete
...
Published reference: https://aibot88.github.io/CVERequest/platform/issue4.html
